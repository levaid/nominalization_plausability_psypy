...
datafile = datafile_raw[['ItemNum', 'Pic_Sent', 'Plaus_Implaus', 'Stimulus', 'List', 'img_name', 'banreti', 'nom',
                         'nom1_ap', 'nom2_ap', 'szórend']]
...
for line in datafile.values:
    num, picsent, plaus, title, list_index, imgname, sentence, nomin, nom1ap, nom2ap, svo_order = line
    if list_index == 1:
        if picsent == 'pic':
    ...
    if iteration_index % 10 == 0 and blocks[iteration_index//10] == 'image':
        instructions += [visual.TextStim(
                            ...
                            text='Ön képeket fog látni. Majd a képernyő jobb alsó sarkában két felirat jelenik meg' +
                                 ...
                                 'Figyelem! A feliratok választásához rövid idő áll rendelkezésre.' +
                                 'Amennyiben nem választott feliratot, a teszt végén megismétlődik egyszer a kép.\n' +
    ...
    if iteration_index % 10 == 0 and blocks[iteration_index//10] == 'sentence':
        instructions += [visual.TextStim(
                            ...
                            text='Ön mondatokat fog látni. Majd a képernyő jobb alsó sarkában két felirat jelenik meg.'+
                                 ...
                                 'A feliratok közül a ⅄ és Ɔ gomb egyszeri lenyomásával válasszon.' + '\n' +
                                 'Figyelem! A feliratok választásához rövid idő áll rendelkezésre.' +
                                 'Amennyiben nem választott feliratot, a teszt végén megismétlődik egyszer a mondat.\n'+
                                 'Nyomjon szóközt a továbbhaladáshoz.',
                            pos=(0, 0),
                            height=0.05,
                            wrapWidth=1.3)]
...
start_and_end += [visual.TextStim(
        ...
        name=f'H{i}',
        font='Noto Sans',
        text='A space megnyomása után meg fog jelenni egy kis ablak, amibe kérjük írja be az ' +
             'észrevételeit és hogy milyen stratégiát alkalmazott, amikor válaszolt.' +
             'Miután beírta, nyomja meg az OK gombot.' + '\n' +
...
for global_index, key_resp, stimulus, orders, nom in zip(range(len(stimuli)), key_responses, stimuli, nomin_orders, nominalizations):
